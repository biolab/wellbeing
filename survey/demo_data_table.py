...
def create_data_table():
    ...
    for i, file_name in enumerate(file_names):          # enumerate files > to set columns with keys of the first file accordingly.
        ...
        if i == 0:                                      # when the first file is processed
            ...
            data_table.columns = cols                   # set these keys as the column names of data table. this ensures that when concatenating dataframes together, the column will pair up correctly
